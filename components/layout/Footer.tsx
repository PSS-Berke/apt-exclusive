        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <a
                href="mailto:wholesale@abt.com"
                className="flex items-center gap-2 text-gray-300 hover:text-gold transition-colors text-sm"
              >
                <Mail className="w-4 h-4" />
                <span>wholesale@abt.com</span>
              </a>
              <a
                href="mailto:press@abt.com"
                className="flex items-center gap-2 text-gray-300 hover:text-gold transition-colors text-sm"
              >
                <Mail className="w-4 h-4" />
                <span>press@abt.com</span>
              </a>
              <a
                href="mailto:support@abt.com"
                className="flex items-center gap-2 text-gray-300 hover:text-gold transition-colors text-sm"
              >
                <Mail className="w-4 h-4" />
                <span>support@abt.com</span>
              </a>
            </div>
      ...
      <div className="border-t border-navy-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-sm text-gray-400 text-center md:text-left">
            &copy; {new Date().getFullYear()} Abt Exclusive. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
